...
// Scopes to request.
const OAUTH_SCOPES = ['user-read-email', 'user-modify-playback-state', 'user-read-currently-playing'];
    ...
    cookieParser()(req, res, () => {
      ...
      Spotify.authorizationCodeGrant(req.query.code, (error, data) => {
        ...
        Spotify.getMe(async (error, userResults) => {
          ...
          const profilePic = userResults.body['images'][0]? userResults.body['images'][0]['url'] : undefined;
